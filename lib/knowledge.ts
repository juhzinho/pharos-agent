...
AGENT ACTIONS: swap (LI.FI or FaroSwap direct) | bridge (LI.FI, CCIP, or CCTP v2) | add_liquidity (FaroSwap V3 WPROS/USDC) | remove_liquidity (FaroSwap V3) | view_positions | view_wallet | stake PROS → stPROS (Faroo liquid staking, ERC-4626; min 0.1 PROS, guided flow with % buttons + custom amount) | unstake stPROS → PROS (guided flow) | staking position view (stPROS balance, NAV, PROS value — user asks "my staking" / "meu stake") | live global RWA market data (rwa.xyz: aggregates, top networks, leaders by asset class — user asks "rwa market" / "mercado rwa")
