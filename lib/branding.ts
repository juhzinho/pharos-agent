// Public agent branding (Anvita / marketplace compliance).
// ProsPilot is an independent community project — not an official Pharos Network product.

export const AGENT_NAME = "ProsPilot";
export const AGENT_SKILL_ID = "prospilot";

export const AGENT_TAGLINE =
  "Community-built DeFi copilot for the Pharos ecosystem";

export const AGENT_DISCLAIMER =
  "Independent community project — not affiliated with or endorsed by Pharos Network official team.";
